...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['remove_profile_picture'])) {
        ...
        if (mysqli_query($con, $sql)) {
            header("Location: loginsystem_data.php?id=$id");
            exit();
        } else {
...
<div class="container">
    <div class="row col-md-8 border rounded mx-auto mt-5 shadow-lg p-2">
        ...
        <div class="col-md-9">
            <div class="h2 d-flex justify-content-center">Edit user </div>
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="d-grid gap-1 d-md-flex justify-content-md-center">
                        ...
                        <a href="loginsystem_data.php?id=<?php echo $id; ?>" class="col-md-6 col-12"><button class="btn col-12 btn-secondary " style="border-radius:0px;" type="button">Go Back</button></a>
                    </div>
            </form>
        </div>
    </div>
